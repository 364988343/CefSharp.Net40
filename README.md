...
|----------------------------------------------------------------------|------|------|-------|-----------------|
| [master](https://github.com/cefsharp/CefSharp/)                      | 3809 | 2015 | 4.5.2 | Development     |
...
*.NET 4.5.2 is officially supported, while .NET 4.0 is unofficially supported and may be withdrawn in future releases.
